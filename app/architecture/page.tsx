...
export default function ArchitecturePage() {
  return <main><section className="card"><h1>Data transparency</h1><p>The app distinguishes external observations, calculated guidance, and user-created records so demo data is never mistaken for live information.</p><div className="grid">
    ...
    <article className="card"><h2>Generative AI</h2><p>Gemini receives fresh weather plus user-provided household and travel context through a server-only API. Structured output provides multilingual plans, checklists, advisories, recommendations, and phase-specific alerts.</p></article>
